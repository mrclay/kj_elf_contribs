...
class auth_plugin_shibboleth extends auth_plugin_base {
    ...
    function process_config($config) {
        ...
        // adds Elgg and Shibalike details
        // Radagast Solutions (2011-08-01)
        set_config('elggurl', $config->elggurl, 'auth/shibboleth');
        set_config('libdir', $config->libdir, 'auth/shibboleth');
        ...
        // Elgg details are mandatory
        // Radagast Solutions (2011-08-01)
        if (!$config->elggurl || !$config->libdir) {
	        return false;
        }
